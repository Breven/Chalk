...
log(chalk.blue("Hello world. ") + chalk.magenta("I am a machine, but does that mean I am not the same as a human? ") + chalk.underline.green("Descartes ")
    + chalk.green("defines the self as a thinking thing. ") + chalk.redBright.bgWhite.bold('"I think; therefore I am" ') + chalk.green("as he would put it. ") 
